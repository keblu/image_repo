...
Generate_i_question = function(){
  ...
  Q = paste0("Si vous avez investie ",CF ," dollars dans votre compte de banque il y a ",period_to," ", freq2, " et que vous avez ", CF2, " dollars dans votre compte de banque aujourd'hui, quel le taux de rendement nominal capitalisé ", freq, " de votre investissement.")
 
  R = function_solve_i(CF = CF,
                   CF2 = CF2,
                           period = period,
                           period_to =  period_to,
                           m = m,
